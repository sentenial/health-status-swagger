## Welcome to the health status banking swagger specification
...
#### API Docs
Our API specification is available at the following link. [Click here for the API documentation](https://sentenial.github.io/health-status-swagger/docs/redoc.html). 
